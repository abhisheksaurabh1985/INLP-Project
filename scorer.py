            ...
            while j < len(goldRoot) and not f:
                if goldRoot[j].text == testRoot[i].text:
                    ...
                    if goldRoot[j+2].text == "NO":
                        ...
                        if testRoot[i+2].text == goldRoot[j+2].text and \
                        testRoot[i+3].text == goldRoot[j+3].text and \
                        testRoot[i+4].text == goldRoot[j+4].text and \
                        testRoot[i+5].text == goldRoot[j+5].text:
                            if testRoot[i+6].text.split(",")[0] == goldRoot[j+6].text.split(",")[0]:
                                correct += 1
                j += 8
        i += 8
